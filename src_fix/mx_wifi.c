  ...
  if (Obj->Runtime.interfaces == 0u)
  {
    ...
    if (MIPC_CODE_SUCCESS == mipc_init(Obj->fops.IO_Send))
    {
                                   ...
                                   MX_WIFI_RECEIVED_THREAD_PRIORITY))
      {
        ...
        DEBUG_ERROR("Requesting firmware version... \n");
                                              ...
                                              MX_WIFI_CMD_TIMEOUT))
        {
          ...
          DEBUG_ERROR("Requesting MAC address... \n");
                                                ...
                                                MX_WIFI_CMD_TIMEOUT))
          {
            ...
            DEBUG_ERROR("WiFi initialization successful! \n");
          }
        }
      }
    }
